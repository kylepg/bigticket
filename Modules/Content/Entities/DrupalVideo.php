...
class DrupalVideo extends Model
{
    use HasUuid;
    ...
    public function drupalVideoCaption()
    {
        return $this->hasMany(DrupalVideoCaption::class);
    }
    ...
    public function drupalPublished()
    {
        ...
        $url = 'https://api.nba.net/2/celtics/video/'.$this->drupal_uuid;
